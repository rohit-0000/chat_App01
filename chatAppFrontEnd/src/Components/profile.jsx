...
import { deleteProfileImg, setProfileImg, updateUser } from "../Reducer/chatSlice";
...
const profile = () => {
  ...
  function handleImgInput(e){
    ...
    if(img && img.type.startsWith("image/")){
      ...
      dispatch(setProfileImg(formData));
    }else{
      ...
      <div className="bg-[#ffffff11] w-full min-h-screen  rounded-xl flex flex-col justify-center items-center md:px-20 py-10 gap-10 ">
        ...
        >
          ...
          {isImgHover && (
            <img
              src={EditImg}
              className="absolute top-0 left-0 w-[60vw] h-[60vw] md:w-90 md:h-90 p-[40%] md:p-35 bg-[#000000a7] rounded-xl"
              onClick={handleImgClick}
            />
          )}
          <input type={"file"} accept="image/*" className="hidden" ref={imgInputRef} onChange={handleImgInput}/>
          ...
          {clickOption && (
            <div
              ...
              ref={btnRef}
            >
              <button className="hover:border w-full rounded-md py-1" 
              onClick={handleEditImg}>
                Change
              </button>
              {user.userImageUrl && <button className="hover:border w-full rounded-md py-1" onClick={handleImgRemove}>Remove</button>}
              <button
        ...
        >
          ...
          </div><div className="flex items-center flex-col md:flex-row w-full justify-between">
